export const siteConfig = {
  ...
  description:
    "Ali Hamza is a Full Stack Developer in Lahore, Pakistan, building MERN, Next.js, AWS serverless, REST APIs, and blockchain apps for startups and product teams worldwide.",
