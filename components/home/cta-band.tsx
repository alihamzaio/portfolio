...
export function CtaBand() {
  ...
  return (
    <section
      ...
      className="relative py-[var(--space-7)] border-y border-[var(--border-subtle)] bg-[var(--bg-primary)] overflow-hidden"
    >
      ...
      <div className="site-grid relative z-[1] flex flex-col lg:flex-row lg:items-end lg:justify-between gap-[var(--space-5)]">
        <div data-animate>
          ...
          <p className="type-body-sm mt-[var(--space-3)] max-w-lg text-[var(--text-secondary)]">
