...
export function HeroOrb() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 rounded-full bg-[#00FFB2]/20 blur-[80px] animate-pulse" />
      <div ref={orbRef} className="relative w-[280px] h-[280px] sm:w-[340px] sm:h-[340px]">
        <svg viewBox="0 0 400 400" className="w-full h-full" aria-hidden>
          <defs>
            <radialGradient id="orbGrad" cx="40%" cy="35%">
              ...
              <stop offset="45%" stopColor="#00FFB2" stopOpacity="0.5" />
              <stop offset="100%" stopColor="#050505" stopOpacity="0" />
            </radialGradient>
            <linearGradient id="ringGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#00FFB2" />
              <stop offset="50%" stopColor="#7CFFCB" />
          ...
          {[0, 60, 120, 180, 240, 300].map((deg, i) => {
            ...
            return (
              <circle key={i} cx={x} cy={y} r="3" fill="#00FFB2" opacity="0.6">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="glass-card rounded-2xl px-5 py-3 border-[#00FFB2]/20 glow-emerald-sm">
            <p className="text-xs font-mono text-[#7CFFCB] tracking-widest uppercase">Systems Online</p>
